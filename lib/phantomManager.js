...
var PhantomManager = module.exports = function (options) {
    ...
    this.options.portLeftBoundary = this.options.portLeftBoundary || 10000;
    this.options.portRightBoundary = this.options.portRightBoundary || 30000;
    ...
    if (cluster.worker) {
        this.options.portLeftBoundary = this.options.portLeftBoundary + (((this.options.portRightBoundary - this.options.portLeftBoundary) / 5) * (cluster.worker.id - 1));
    }
